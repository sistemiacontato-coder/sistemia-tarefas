  ...
  return (
    <div className="layout-container">
      ...
      {ctxMenu && (() => {
        ...
        const isArch = archivedProjects.has(ctxMenu.task.id);
        ...
        return (
          <>
            ...
            <div style={{ position: 'fixed', left, top, zIndex: 50, background: 'var(--surface-high)', border: '1px solid var(--outline-variant)', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-lg)', minWidth: '160px', overflow: 'hidden', padding: '4px 0' }} onClick={e => e.stopPropagation()}>
              <button style={itemStyle} onMouseOver={e => e.currentTarget.style.background = 'var(--surface-hover)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'} onClick={() => { setEditingTask(ctxMenu.task); setCtxMenu(null); }}>
                <span className="material-symbols-outlined" style={{ fontSize: '16px', color: 'var(--primary)' }}>edit</span>Editar
              </button>
              <button style={itemStyle} onMouseOver={e => e.currentTarget.style.background = 'var(--surface-hover)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'} onClick={() => { setDuplicatingTask(ctxMenu.task); setCtxMenu(null); }}>
                <span className="material-symbols-outlined" style={{ fontSize: '16px', color: 'var(--text-muted)' }}>content_copy</span>Duplicar
              </button>
              <button style={itemStyle} onMouseOver={e => e.currentTarget.style.background = 'var(--surface-hover)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'} onClick={() => { toggleArchive(ctxMenu.task.id); setCtxMenu(null); }}>
              ...
              <div style={{ borderTop: '1px solid var(--outline)', margin: '4px 0' }} />
              <button style={{ ...itemStyle, color: '#ef4444' }} onMouseOver={e => e.currentTarget.style.background = 'rgba(239,68,68,0.08)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'} onClick={() => { setDeletingTaskId(ctxMenu.task.id); setCtxMenu(null); }}>
